/** Video — a URL (external or picked from the media library) + optional caption. */
export default class Video {
    static get toolbox() {
        return {
            title: 'Video',
            icon: '<svg width="17" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="15" height="14" rx="2"/><polygon points="22 7 17 10 17 14 22 17 22 7"/></svg>',
        };
    }
    ...
    constructor({ data, block }) {
        ...
        this.block = block;
        this.target = 'video-' + Math.random().toString(36).slice(2);
        this.wrapper = null;
    ...
    render() {
        ...
        this.urlInput.placeholder = 'https://…/video.mp4';
